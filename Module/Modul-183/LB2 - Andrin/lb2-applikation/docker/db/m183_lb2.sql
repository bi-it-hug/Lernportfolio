...
insert into users (ID, username, password) values (1, 'admin1', '$2b$12$VFcYSCul5LewugixgxUDuef4BZZIxiNWNjxt2P2Ug/vREIf.tHIh.');
insert into users (ID, username, password) values (2, 'user1', '$2b$12$BiPvNmeIsUVuZ2d.tWVhNumXA7OJOhacVTB5HysLpNqUu/OGR9YdS');
