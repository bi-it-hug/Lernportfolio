...
```mermaid
%% KS Textil AG Organigramm
graph TD
    A[Dr. Lutz<br>Delegierter Verwaltungsrat]:::chef
    A1[Direktionssekretärin<br>Frau Hofmann]:::sekretariat
    A2[Fachbereich Betriebswirtschaft<br>Herr Meier]:::fachbereich
    A3[Fachbereich Marketing<br>Herr Guntern]:::fachbereich
    A4[Fachbereich Controlling<br>Frau Schmid]:::fachbereich

    %% Verwaltung und Produktion
    B[Verwaltung<br>Leitung: Hr. Büchler]:::bereich
    C[Produktion<br>Leitung: Hr. Stamm]:::bereich

    %% Verwaltung Abteilungen
    B1[Finanz- und Rechnungswesen<br>Leitung: Hr. Dill, Prokurist]:::abteilung
    B1a[Chef Finanzbuchhaltung<br>Hr. Müller, HB]:::mitarbeiter
    B1b[Chef Betriebsbuchhaltung<br>Hr. Rohner, HB]:::mitarbeiter

    B2[Verkauf<br>Leitung: Hr. Radsack, Prokurist]:::abteilung
    B2a[Verkauf Schweiz<br>Hr. Muff, HB]:::mitarbeiter
    B2b[Verkauf Ausland<br>Hr. Stauffer, HB]:::mitarbeiter

    B3[Administration / Disposition<br>Leitung: Frau Knecht, HB]:::abteilung

    %% Produktion Abteilungen
    C1[Zwirnerei und Weberei<br>Leitung: Hr. Stoob, ppa.]:::abteilung
    C2[Ausrüsterei und Färberei<br>Leitung: Hr. Neff, i.V.]:::abteilung
    C3[Konfektionierung<br>Leitung: Hr. Bachmann, i.V.]:::abteilung
